...
export default {
	...
	// cacheDirectory: "C:\\Users\\NPC250\\AppData\\Local\\Temp\\jest",
	...
	// 模拟测试的测试环境（node | jsdom）  The test environment that will be used for testing
	testEnvironment: 'jsdom',

	// 配置测试环境信息  Options that will be passed to the testEnvironment
